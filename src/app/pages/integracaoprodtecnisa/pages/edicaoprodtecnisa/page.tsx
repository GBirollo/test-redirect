...
import TabsProdTecnisa from '../../../../components/tabsprodtecnisa';


const EdicaoProdTecnisa = () => {

    return (
      <div className="container-fluid editar-prodtecnisa">
        <TabsProdTecnisa />
        <div className="p-4">
...
export default EdicaoProdTecnisa;
